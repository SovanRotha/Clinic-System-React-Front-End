...
function ViewAppointment() {
  ...
  useEffect(() => {
    const fetchAppointment = async () => {
      try {
        ...
        console.error(error);
        alert(error.message || "Failed to load appointment");
      } finally {
        setLoading(false);
      }
    };
  ...
  const status = statusConfig[appointment?.status?.toLowerCase()] || {
          ...
          <div style={s.headerRow}>
            <div>
              ...
              <p style={s.pageSubtitle}>
                Appointment #{appointment?.id} · Read-only view
              </p>
            </div>
            <span
              style={{
        ...
        <div style={s.grid2}>
          <div style={s.card}>
            <p style={s.sectionLabel}>
              <UserIcon color="#94A3B8" /> Patient
            </p>
            <div style={s.avatarRow}>
              <div
                style={{ ...s.avatar, background: "#EFF6FF", color: "#1D4ED8" }}
              >
          ...
          <div style={s.card}>
            ...
            <div style={s.avatarRow}>
              <div
                style={{ ...s.avatar, background: "#F0FDF4", color: "#15803D" }}
              >
              ...
              <div>
                <p style={s.personName}>
                  Dr. {appointment?.doctor?.user?.name || appointment?.user?.name || "Unknown"}
                </p>
                <p style={s.personCode}>
