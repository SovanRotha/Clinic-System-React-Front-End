...
function PatientDashboard() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            fetch("http://localhost:8000/api/my-appointments",  { headers: { Authorization: `Bearer ${token}`, Accept: "application/json" } }).then(r => r.json()),
            fetch("http://localhost:8000/api/my-consultations", { headers: { Authorization: `Bearer ${token}`, Accept: "application/json" } }).then(r => r.json()),
            fetch("http://localhost:8000/api/my-prescriptions", { headers: { Authorization: `Bearer ${token}`, Accept: "application/json" } }).then(r => r.json()),
            fetch("http://localhost:8000/api/my-bills",         { headers: { Authorization: `Bearer ${token}`, Accept: "application/json" } }).then(r => r.json()),
        ])
